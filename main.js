...
function apply_matrix(threeMatrix, DOMElement) {
  const cssVal =
    "perspective(" + DOMElement.style.perspective + ")" + " matrix3d(" + threeMatrix.elements.join(",") + ")";
...
function init_scene(spec) {
  ...
  console.log({ canvas, domRect, width, height });
...
function main() {
  ...
  JEELIZFACEFILTER.init({
    ...
    videoSettings: {
      videoElement,
      idealWidth: videoElement.width,
      idealHeight: videoElement.height,
